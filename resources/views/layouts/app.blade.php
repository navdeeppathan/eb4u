    ...
    <div class="bg-darkBlack-950 text-white text-xs py-2.5 px-4 md:px-12 z-50 border-b border-darkBlack-800">
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex sm:hidden w-full justify-between items-center text-[10px] font-medium">
                <span class="truncate pr-2"><i class="fa-solid fa-store text-brandOrange-500 mr-1"></i> Store Pickup: {{ \App\Models\SystemSetting::get('store_address', 'Near, 103 Inwood Rd, Hounslow TW3 1XA') }}</span>
            ...
            <div class="hidden sm:flex items-center justify-between w-full text-xs">
                <div class="flex items-center space-x-4">
                    <span class="whitespace-nowrap"><i class="fa-solid fa-store text-brandOrange-500 mr-1"></i> Store Pickup Only | {{ \App\Models\SystemSetting::get('store_address', 'Near, 103 Inwood Rd, Hounslow TW3 1XA') }}</span>
