...
<div x-show="isCartOpen" x-cloak class="relative z-50">
    ...
    <div class="fixed inset-y-0 right-0 max-w-full flex pl-4 sm:pl-10">
        <div x-show="isCartOpen" x-transition:enter="transform transition ease-in-out duration-300"
            ...
            <!-- Cart Header -->
            <div class="p-5 sm:p-6 border-b border-cream-200 flex items-center justify-between bg-cream-100/60">
                <div class="flex items-center space-x-2">
                    <i class="fa-solid fa-basket-shopping text-amberAcc-600 text-xl"></i>
                    <h2 class="text-base sm:text-lg font-black text-forest-900">Your Basket</h2>
            ...
            <div class="flex-grow overflow-y-auto p-4 sm:p-6 space-y-4">
                ...
                <template x-for="item in cartItems" :key="item.id">
                    <div class="flex space-x-3 sm:space-x-4 p-3 rounded-2xl border border-cream-200 bg-cream-50/60 hover:bg-white transition-colors relative group">
                        <img :src="item.image" class="w-14 h-14 sm:w-16 sm:h-16 object-cover rounded-xl border border-cream-200">
                        <div class="flex-grow">
                            <div class="flex justify-between items-start">
                                <h4 class="text-xs font-black text-forest-900 leading-tight pr-2" x-text="item.name"></h4>
            ...
            <!-- Cart Footer Summary -->
            <div x-show="cartItems.length > 0" class="p-5 sm:p-6 border-t border-cream-200 bg-cream-100/60 space-y-3">
                ...
                <div class="border-t border-cream-200 pt-2 flex justify-between text-sm font-black text-forest-900">
                    ...
                    <span class="text-amberAcc-600 text-base sm:text-lg font-black">£<span x-text="total"></span></span>
                </div>
